...
namespace FGS.AspNetCore.Http.Extensions.AWS.ALB
{
    public static class AwsAlbApplicationBuilderExtensions
    {
        ...
        /// <remarks>
        /// <para>
        ///     This adapter on top of <see cref="Microsoft.AspNetCore.Builder.ForwardedHeadersExtensions.UseForwardedHeaders"/> is needed when the application is running behind an AWS Application Load Balancer and the consumer wishes to leverage forwarded headers.
