...
{
    /// <remarks>Taken and modified from: https://github.com/autofac/Autofac.Mvc/blob/e26ce3fe9ccc639f1349bcd8aee8e6e4ee066346/test/Autofac.Integration.Mvc.Test/AuthorizationFilterFixture.cs </remarks>
    public class AuthorizationFilterTests : AutofacFilterBaseFixture<TestAuthorizationFilter, TestAuthorizationFilter2, IAuthorizationFilter>
    {
        ...
        {
            return r => r.AsAuthorizationFilterWhen((cc, ad) => cc.Controller is TestController, FilterScope.Controller, order: -1);
        }
        ...
        {
            return r => r.AsAuthorizationFilterWhen((cc, ad) => cc.Controller is TestController && ad.ActionName == nameof(TestController.Action1), FilterScope.Action, order: -1);
        }
        ...
        {
            return r => r.AsAuthorizationFilterWhen((cc, ad) => cc.Controller is TestController, FilterScope.Controller, order: 20);
        }
        ...
        {
            return r => r.AsAuthorizationFilterWhen((cc, ad) => cc.Controller is TestController && ad.ActionName == nameof(TestController.Action1), FilterScope.Action, order: 20);
        }

        protected override Action<ContainerBuilder> ConfigureControllerFilterOverride()
        {
            return builder => builder.RegisterAuthorizationFilterOverrideForWhen((cc, ad) => cc.Controller is TestController, FilterScope.Action);
        }

        protected override Action<ContainerBuilder> ConfigureActionFilterOverride()
        {
            return builder => builder.RegisterAuthorizationFilterOverrideForWhen((cc, ad) => cc.Controller is TestController && ad.ActionName == nameof(TestController.Action1), FilterScope.Action);
        }
        ...
        {
            return r => r.AsAuthorizationFilterOverrideWhen((cc, ad) => cc.Controller is TestController && ad.ActionName == nameof(TestController.Action1), FilterScope.Action, order: 0);
        }
        ...
        {
            return r => r.AsAuthorizationFilterOverrideWhen((cc, ad) => cc.Controller is TestController, FilterScope.Controller, order: 0);
        }
